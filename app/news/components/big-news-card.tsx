...
export function BigNewsCard({ news }: BigNewsCardProps) {
            ...
            >
                ...
                <Card className="border-0 rounded-none flex-1 cursor-pointer dark:bg-[rgba(40,23,25,0.9)]">
                    <div className="pt-0 p-6 h-full flex flex-col">
                        <motion.h2 layoutId={`news-title-${news.id}`} className="text-2xl font-bold mb-0 line-clamp-2">
                            {news.title}
                        </motion.h2>
                        {news.publishedAt && (
                        ...
                        <p className="text-gray-600 dark:text-gray-400 line-clamp-3 flex-1 text-m">
                            {news.description}
                        </p>
                    </div>
                </Card>
